...
const Header = () => {
    return (
        <section className="relative overflow-hidden mb-10 w-full ">
            ...
            {/* Contenido de texto */}
            <div className="container mx-auto px-0 md:px-8 -m-6 sm:m-0">
                <div className=" relative z-10 md:absolute md:top-1/2 md:left-12 md:-translate-y-1/2 bg-white py-8 sm:p-8 flex flex-col items-center md:items-start text-center md:text-left max-w-lg">
